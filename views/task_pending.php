...
<div class="formTaskPending">
    ...
    <label for="id" >Usuario:  <?= $_GET['user_id'] ?? ''?></label>
    <br><br>
...
osea pasa de falso a verdadero y de verdadero a falso-->                   
            ...
            <?php else: ?> <!--Sino en las 4 celdas se sobreescribe -->
                <tr><td colspan="5">No hay tareas pendientes.</td></tr>
            <?php endif; ?> <!--Se cierra el if-->
        </tbody>
    </table>
    <br>
    <!--REDIRIGE al controlador principal de tareas con el valor del user_id -->
        <a href="../controllers/task_controller.php?id=<?= htmlspecialchars($user_id) ?>" class="button">Volver a la lista completa</a>
