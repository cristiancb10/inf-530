...
<div class="formUserDelete">
    ...
    <p>¿Esta seguro de eliminar al usuario <?=$userData['name']?>?</p>
        ...
        <input type="number" value="<?= htmlspecialchars($userData['id'])?>" disabled> </input>
        <br>
        <label for="name">Nombre:</label>
        <input type="text" value="<?= htmlspecialchars($userData['name'])?>" disabled> </input>
        <br>
        <label for="email">Correo:</label>
        <input type="email" value="<?= htmlspecialchars($userData['email'])?>" disabled> </input>
        <br>
